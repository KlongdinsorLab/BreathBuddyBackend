...
import { updateCurrentDifficulty } from "../common/_shared/playerService.ts";
...
Deno.serve(async (req) => {
  ...
  try{
    const { difficulty_id } = await req.json()
    ...
    await updateCurrentDifficulty(playerId,difficulty_id)
