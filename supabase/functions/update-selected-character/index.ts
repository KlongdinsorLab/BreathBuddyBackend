...
import { updateSelectedCharacter } from "../common/_shared/playerService.ts";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    await updateSelectedCharacter(playerId, character_id);
...
/* To invoke locally:
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/update-selected-character' \
