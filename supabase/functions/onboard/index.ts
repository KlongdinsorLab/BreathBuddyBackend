...
//https://github.com/zebedeeio/zbd-supabase-edge-functions-example/blob/main/functions/zbd-send/index.ts
//
...
//    const taskPattern = new URLPattern({ pathname: '/onboard/:id' })
