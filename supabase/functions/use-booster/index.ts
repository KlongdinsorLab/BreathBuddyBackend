...
import { useBooster } from "../common/_shared/boosterService.ts";
...
Deno.serve(async (req) => {
  ...
  try{
    ...
    await useBooster(playerId, booster_id)
...
/* To invoke locally:
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/use-booster' \
